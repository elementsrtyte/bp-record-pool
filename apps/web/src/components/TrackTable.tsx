      ...
      <table className="w-full min-w-[640px] border-collapse text-left text-sm">
        <thead>
          <tr className="border-b border-border bg-muted/30 text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
            ...
            <th className="hidden w-20 px-2 py-2.5 font-medium xl:table-cell">Key</th>
        ...
        <tbody>
          {items.map((t, i) => (
            ...
            >
              ...
              <td className="hidden px-2 py-2 tabular-nums text-xs text-muted-foreground lg:table-cell">—</td>
              <td className="hidden px-2 py-2 text-xs text-muted-foreground xl:table-cell">—</td>
